window.__ModuleLoader__.load({
  id: "awesome-dsh-background-plugin",
  factory: (require) => {
    var module = { exports: {} };
    ...
    const STYLE_ID = "awesome-dsh-background-plugin-style";
    ...
    function installStyle() {
      ...
      style.id = STYLE_ID;
      style.dataset.plugin = "awesome-dsh-background-plugin";
    ...
    function BackgroundRow({ t, scope, runtime }) {
      ...
      const toggleEnabled = async () => {
        ...
        setDraft((previous) => ({ ...previous, enabled: next }));
        runtime.preview({ ...draft, enabled: next });
        setDirty(true);
        setTone("");
        setMessage(t("changed"));
        try {
      ...
      const selectPreset = async (preset) => {
        ...
        try {
          ...
          await scope.set("preset", preset);
          await scope.set("image", "");
          await scope.set("fileName", "");
        } catch {
          setMessage(t("storageError"));
          setTone("error");
        }
      ...
      return h("div", { className: "dsh-background-row" },
        h("div", { className: "dsh-background-head" },
          ...
          h("button", { className: "dsh-background-toggle", type: "button", "data-on": active, "aria-pressed": active, onClick: () => toggleEnabled() },
        ...
        h("div", { className: "dsh-background-preview" },
          ...
          h("div", { className: "dsh-background-preview-copy" },
            h("div", { className: "dsh-background-preview-kicker" }, "PERSONAL SPACE"),
